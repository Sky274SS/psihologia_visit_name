...
(function (p, b) {
    ...
    const p = /^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/,
        b = /^[0-9]+$/, g = /^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$/,
        x = /^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}$/, I = n => {
            let e = n;
            return typeof n == "string" && (e = n.trim()), !e
        }, T = n => p.test(n), $ = (n, e) => n.length > e, M = (n, e) => n.length < e, V = n => b.test(n),
        P = n => g.test(n), j = n => x.test(n), G = (n, e) => n > e, A = (n, e) => n < e;
    var d;
    (function (n) {
    ...
    const N = (n, e) => {
            switch (n) {
                ...
                case d.MaxLength:
                    return "Поле должно содержать не более :value символов".replace(":value", String(e));
                case d.MinLength:
                    return "Поле должно содержать не менее :value символов".replace(":value", String(e));
                case d.Password:
    ...
    class O {
        ...
        validateFieldRule(e, t, s, i = !1) {
            const r = s.value, a = this.getElemValue(t);
            if (s.plugin) {
            ...
            switch (s.rule) {
                ...
                case d.Files: {
                    ...
                    if (typeof a == "object" && a !== null) for (let c = 0, h = a.length; c < h; ++c) {
                        const f = a.item(c);
                        if (!f) {
                            this.setFieldInvalid(e, s);
                            break
                ...
                default: {
                    ...
                    if (typeof l != "boolean" && typeof l != "function" && console.error(`Validator return value for [${e}] field should be boolean or function. It will be cast to boolean.`), typeof l == "function") if (i) this.fields[e].asyncCheckPending = !0; else {
        ...
        validate() {
            return new Promise(e => {
                ...
                Object.keys(this.fields).forEach(s => {
                    const i = this.fields[s], r = this.validateField(s, i);
                    F(r) && t.push(r)
                }), Object.keys(this.groupFields).forEach(s => {
                    const i = this.groupFields[s], r = this.validateGroup(s, i);
                    F(r) && t.push(r)
        ...
        addRequiredGroup(e, t, s, i) {
            ...
            const a = r.querySelectorAll("input"), l = Array.from(a).every(c => c.type === "radio"),
        ...
        renderTooltip(e, t, s) {
            var f;
            const {top: i, left: r, width: a, height: l} = e.getBoundingClientRect(), o = t.getBoundingClientRect(),
